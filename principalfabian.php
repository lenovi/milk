...
<!--  contenido primer tab -->        
    <div id="content_1" class="content">
        	<ul>
            	<li><iframe  align="center" frameborder=0 height="73%" width="100%" src="http://proalba.com.co/principalingresar.php"></iframe></li>
			</ul>
    </div>
...
<!-- segundo tab -->
    <div id="content_2" class="content">
        	<ul>
            	<li><iframe  align="center" frameborder=0 height="73%" width="100%" src="http://proalba.com.co/buscar-recepcion/principal.php"></iframe></li>
			</ul>
    </div>
...
<!-- tercer tab -->
    <div id="content_3" class="content" style="display: none;">
			...
			<ul>
            	<li>
				<iframe  align="center" frameborder=0 height="73%" width="100%" src="http://www.proalba.com.co/reporte15/index.php" scrolling="yes" name="aa"></iframe>
</li>
			</ul>
