...
<tr>
    ...
    <tr>
        ...
        <td>
            ...
            <input type="radio" name="i_tipoUsuario" id="i_tipoUsuario"  value="2" checked="checked"  /> Usuario normal &nbsp;&nbsp;&nbsp;
            <input type="radio" name="i_tipoUsuario" id="i_tipoUsuario"  value="1"  /> Administrador
        </td>
    </tr>
