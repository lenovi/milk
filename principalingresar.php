...
//echo $ruta; se envia ruta desde guardar.php, pero no la necesita para funcionamiento normal de este script
...
<!DOCTYPE html>
<!-- saved from url=(0059)http://proalba.com.co/innmilk/operacion/recepcion/adicionar -->
...
footer a:hover{
    color:#00A599;
        ...
        <style media="" data-href="form.css">select, textarea, input[type="text"], input[type="password"],, input[type="datetime-local"], input[type="month"], input[type="time"], input[type="week"], input[type="email"], input[type="url"], input[type="search"], input[type="tel"], input[type="color"], .uneditable-input {
						...
						<div id="demo" align="center" >
							<table  border="1" >
								...
								<tr>
									...
									<p align="center">
									<input type="text"  name="fecha" id="datepicker"value=<?php  if(isset($fechas)){echo $fechas;} else{ echo date('Y-m-d');  }?> readonly required /></td>
									</p>
									<td  align=center>Ruta<p align="center">
									...
									<p align="center">
									<input type="number" name="cantidad" size="20" min="1" placeholder="Cantidad..." title="Cantidad en Litros" required/></td>
									</p>
...
//echo "Total Litros: ",$sumatoria;
			...
			?>
								...
								<tr>
									<td height="14" align="center" colspan="5">
									<input type="submit" style="height:22px" value="Guardar" name="guardar"></td>
								</tr>
							</table></div>
					</form>
