...
(function( $, undefined ) {
		...
		$.mobile.path = path = {
			...
			makePathAbsolute: function( relPath, absPath ) {
				if ( relPath && relPath.charAt( 0 ) === "http://demos.jquerymobile.com/" ) {
					return relPath;
				}
				...
				var absStack = absPath ? absPath.split( "http://demos.jquerymobile.com/" ) : [],
					relStack = relPath.split( "http://demos.jquerymobile.com/" );
				...
				return "/" + absStack.join( "http://demos.jquerymobile.com/" );
			},
