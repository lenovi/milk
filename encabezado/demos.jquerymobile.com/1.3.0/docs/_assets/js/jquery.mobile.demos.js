	...
	$.widget( "mobile.listview", $.mobile.listview, {
		...
		submitTo: function() {
			...
			var base = $( "base" ).attr( "href" ).split( "docs" )[0];
				base = base.split( "index-2.html" )[0] + "docs" + "/";
...
(function( $, undefined ) {
	...
	$( document ).on( "click", "a", function( e ) {
		...
		if( typeof href !== "undefined" && hash !== "" && href !== href.replace( hash,"" ) && hash.search( "http://demos.jquerymobile.com/" ) !== -1 ){
	...
	$( document ).on("pagebeforechange", function( e,f ){
		...
		if( typeof hash !== "undefined" &&
			hash.search( "http://demos.jquerymobile.com/" ) === -1 &&
			hash !== "" &&
			hashEl.length > 0 &&
...
(function( $, undefined ) {	
	$( document ).on( "mobileinit", function(){
		$.widget( "mobile.listview", $.mobile.listview, {
			...
			_globalnav: function(){
				var base = $( "base" ).attr( "href" ).split('docs')[0],
					base = base.split('index-2.html')[0] + this.options.globalNav + "/";
